...
public class StringToCode {
    ...
    public static String genderCodeReturn(Boolean boy, int selectCheck) {
    ...
    public static String neuterCodeReturn(Boolean neuter, int neutralizeCheck) {
        if (neutralizeCheck == 0) {
            return "3";
        } else if (neuter == true) {
            return "1";
        } else {
