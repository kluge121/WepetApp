...
public class SearchProtect extends FontActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.search_protect_layout);

        Toolbar toolbar = (Toolbar)findViewById(R.id.protect_toolbar);
        toolbar.setContentInsetsAbsolute(0,0);

        backBtn =(ImageButton)findViewById(R.id.protect_back_btn);
        ...
        breedInfo = (TextView)findViewById(R.id.breedInfo2);
        genderInfo = (TextView)findViewById(R.id.genderInfo2);
        ageInfo = (TextView)findViewById(R.id.ageInfo2);
        localInfo = (TextView)findViewById(R.id.localInfo2);
        neutralizeInfo = (TextView)findViewById(R.id.neutralizeInfo2);
        vaccinInfo = (TextView)findViewById(R.id.vaccinInfo2);


        searchAdopt = (ImageView)findViewById(R.id.protectBtn);
        ...
        adopt_breeds = (ImageView)findViewById(R.id.protect_breeds);
        ...
        adopt_gender = (ImageView)findViewById(R.id.protect_gender);
        ...
        adopt_age = (ImageView)findViewById(R.id.protect_age);
        ...
        adopt_live = (ImageView)findViewById(R.id.protect_live);
        ...
        adopt_neutralize = (ImageView)findViewById(R.id.protect_neutralize);
        ...
        adopt_inoculation = (ImageView)findViewById(R.id.protect_inoculation);
        ...
        switch (id) {
            case ADOPT_DIALOG_RADIO1:
                AlertDialog.Builder builder =
                        new AlertDialog.Builder(SearchProtect.this);
