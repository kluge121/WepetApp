...
public class SearchAdopt extends FontActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.search_adopt_layout);

        Toolbar toolbar = (Toolbar)findViewById(R.id.adopt_toolbar);
        toolbar.setContentInsetsAbsolute(0,0);

        backBtn =(ImageButton)findViewById(R.id.adopt_back_btn);
        ...
        genderInfo = (TextView)findViewById(R.id.genderInfo);
        ageInfo = (TextView)findViewById(R.id.ageInfo);
        localInfo = (TextView)findViewById(R.id.localInfo);
        neutralizeInfo = (TextView)findViewById(R.id.neutralizeInfo);
        vaccinInfo = (TextView)findViewById(R.id.vaccinInfo);


        searchAdopt = (ImageView)findViewById(R.id.searchAdopt);
        ...
        adopt_breeds = (ImageView)findViewById(R.id.adopt_breeds);
        ...
        adopt_gender = (ImageView)findViewById(R.id.adopt_gender);
        ...
        adopt_age = (ImageView)findViewById(R.id.adopt_age);
        ...
        adopt_live = (ImageView)findViewById(R.id.adopt_live);
        ...
        adopt_neutralize = (ImageView)findViewById(R.id.adopt_neutralize);
        ...
        adopt_inoculation = (ImageView)findViewById(R.id.adopt_inoculation);
        ...
        switch (id) {
            case ADOPT_DIALOG_RADIO1:
                AlertDialog.Builder builder =
                        new AlertDialog.Builder(SearchAdopt.this);
