...
public class Tab1Fragment extends Fragment {
    static Main owner;
    public  MainListRecyclerViewAdapter Adapter;

    public RecyclerView r;

    //static ArrayList<GetMainListEntity> jsonAdoptList1;
    ...
    public static Tab1Fragment newInstanceDetail(DetailSearchEntity entity) {

        Tab1Fragment tab1FragmentFragment = new Tab1Fragment();
        Bundle bundle = new Bundle();
        bundle.putSerializable("data", entity);
        tab1FragmentFragment.setArguments(bundle);

        return tab1FragmentFragment;
    }
    ...
    public static class MainListRecyclerViewAdapter extends RecyclerView.Adapter<MainListRecyclerViewAdapter.ViewHolder> {
        ...
        public void onBindViewHolder(final ViewHolder holder, final int position) {
            ...
            Glide.with(GetContext.getContext()).load(valueObj.img_thumb).into(holder.itemWindowImage); //픽셀값으로
            ...
            holder.mView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    intent.putExtra("pid", valueObj.pid);
                    intent.putExtra("position", position);
                    intent.putExtra("uid", valueObj.uid);
        ...
        public static class ViewHolder extends RecyclerView.ViewHolder {
            ...
            public void setView(GetMainListEntity data) {
                ...
                this.itemBookMarkNum.setText(String.valueOf(data.bookmark_num));
                this.itemRecommetNum.setText(String.valueOf(data.reply_num));
    ...
    public  ArrayList<GetMainListEntity> getWritingRequestAdot(StringBuilder buf) {

        JSONObject jsonObject;
        JSONArray jsonArray = null;
        ArrayList<GetMainListEntity> jsonList = null;

        try {
            jsonList = new ArrayList<GetMainListEntity>();
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                jsonList.add(getMainListEntity);
            }
            return jsonList;
        ...
        protected ArrayList<GetMainListEntity> doInBackground(Integer... params) {
            ...
            try {
                ...
                Request request = new Request.Builder()
                        .url("http://52.78.104.95:3000/posts?category=" + 1 + "&sort=" + Main.sortType)
                        .build();
    ...
    public class AsyncMainGetDetailSearch extends AsyncTask<DetailSearchEntity, Integer, ArrayList<GetMainListEntity>> {
        protected ArrayList<GetMainListEntity> doInBackground(DetailSearchEntity... params) {
            ...
            try {
                ...
                Request request = new Request.Builder()
                        .url("http://52.78.104.95:3000/posts?category=" + entity.tab + "&gender=" + entity.gender + "&age" + entity.age + "&region=" +
