...
public class Tab2Fragment extends Fragment {
    ...
    static ArrayList<GetMainListEntity> jsonAdoptList2;
    ...
    static String[] state2 = {"", "공고중", "주인을 다시 만났어요", "안락사", "기간만료"};
    static String[] gender = {"", "수컷", "암컷", "gender err"};


    public static Tab2Fragment newInstanceDetail(DetailSearchEntity entity) {

        Tab2Fragment mainListFragment = new Tab2Fragment();
    ...
    public static class MainListRecyclerViewAdapter extends RecyclerView.Adapter<MainListRecyclerViewAdapter.ViewHolder> {
        ...
        public void onBindViewHolder(final ViewHolder holder, final int position) {
            ...
            if (valueObj.state != 1) {
                ...
                holder.itemCorrnetStat.setText(state2[mainArrayList.get(position).state]);
                alpha.setAlpha(200);
            }else {
    ...
    public static ArrayList<GetMainListEntity> getWritingRequestAdot(StringBuilder buf) {
        ...
        try {
            jsonAdoptList2 = new ArrayList<GetMainListEntity>();
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                jsonAdoptList2.add(getMainListEntity);
            }
            return jsonAdoptList2;
        ...
        protected ArrayList<GetMainListEntity> doInBackground(Integer... params) {
            ...
            try {
                ...
                Request request = new Request.Builder()
                        .url("http://52.78.104.95:3000/posts?category=" + 2 + "&sort=" + Main.sortType)
                        .build();
    ...
    public class AsyncMainGetDetailSearch extends AsyncTask<DetailSearchEntity, Integer, ArrayList<GetMainListEntity>> {
        ...
        protected ArrayList<GetMainListEntity> doInBackground(DetailSearchEntity... params) {
            ...
            try {
                ...
                Request request = new Request.Builder()
                        .url("http://52.78.104.95:3000/posts?category=2" + "&gender=" + entity.gender + "&age" + entity.age + "&region=" +
        ...
        protected void onPostExecute(ArrayList<GetMainListEntity> result) {
            try {
                if (result != null && result.size() > 0) {
                    ...
                    Toast.makeText(owner.getApplicationContext(), "해당 조건을 만족하는 글이 없습니다.", Toast.LENGTH_SHORT).show();
                    searchState = REGULAR_SEARCH;
                }
